...
final class LoadAndDisplayImageTask implements Runnable {
    ...
    public void run() {
        ...
        LoadBitmapResult result = new LoadBitmapResult();
        ...
        DisplayBitmapTask displayBitmapTask = new DisplayBitmapTask(bmp, imageLoadingInfo, engine, result.fromCache);
    ...
    private Bitmap tryLoadBitmap(LoadBitmapResult result) {
