    ...
    public void displayImage(String uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener) {
        ...
        if (bmp != null && !bmp.isRecycled()) {
            ...
            if (options.shouldPostProcess()) {
                ...
                ProcessAndDisplayImageTask displayTask = new ProcessAndDisplayImageTask(engine, bmp, imageLoadingInfo, options.getHandler(), true);
                engine.submit(displayTask);
            } else {
                options.getCachedDisplayer().display(bmp, imageView, true);
                // options.getDisplayer().display(bmp, imageView, true);
